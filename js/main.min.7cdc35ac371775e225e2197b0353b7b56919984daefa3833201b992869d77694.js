...
return "";};var cookieInfo=function(){var html='<p id="cookie-info">'+
...
'Infos zu Cookies und Google Analytics</a><span class="clickme">Ich bin einverstanden!</span></p>';$("body").prepend(html);$("#cookie-info .clickme").click(function(){$("#cookie-info").hide();setCookie("cookie-info","accepted",30);});};$(document).ready(function(){if("accepted"!==getCookie("cookie-info")){cookieInfo();}});